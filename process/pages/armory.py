...
class ArmoryProcessor(PageProcessor):
    ...
    def _process_armory_set(self, raw_armory_set):
        armory_collection = self.lookup_files(
            ['armory_collections_1', 'armory_collections_2'], 'gear_set_name', raw_armory_set['name'])
        return {
            ...
            "material_name": self.translate(self.lookup_file("items", 'name', raw_armory_set["material_name"])["name_placeholder"]),
