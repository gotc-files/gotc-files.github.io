...
class TrinketArmoryProcessor(PageProcessor):
    ...
    def _process_trinket_armory_set(self, raw_trinket_armory_set):
        ...
        return {
            ...
            "name": self.translate(raw_trinket_armory_set["name_placeholder"]),
            "description": self.translate(raw_trinket_armory_set["description_placeholder"]),
            "color": _color_to_rgb(raw_trinket_armory_set["color"]),
            "trinkets": [self._process_trinket(trinket_name) for trinket_name in raw_trinket_armory_set["trinket_names"]],
            "bonuses": [self._process_bonus(bonus_name) for bonus_name in trinket_armory_collection["bonuses"]]
        }
