    ...
    def process_proto(self, researches):
        ...
        for research in researches.researches:
            ...
            if len(info.dragon_requirements) == 2:
                research_output["dragon_pit_requirement_progression"] = info.dragon_requirements[0].progression.name
                research_output["dragon_requirement_progression"] = info.dragon_requirements[1].progression.name
